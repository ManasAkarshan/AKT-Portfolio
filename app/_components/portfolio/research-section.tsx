        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <ScrollReveal direction="up" delay={100}>
              <Card className="bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/20 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:border-primary/40 h-full">
                <CardHeader>
            ...
            <ScrollReveal direction="up" delay={200}>
              <Card className="bg-gradient-to-br from-accent/5 to-primary/5 border border-primary/20 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] hover:border-primary/40 h-full">
                <CardHeader>
